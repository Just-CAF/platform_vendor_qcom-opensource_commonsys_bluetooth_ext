...
typedef struct {
  ...
  tBTA_AVK_CO_SINK srcs[BTAV_A2DP_CODEC_INDEX_MAX]; /* array of supported srcs */
  ...
  const tBTA_AVK_CO_SINK* p_sink;         /* currently selected sink */
  const tBTA_AVK_CO_SINK* p_src;          /* currently selected src */
  ...
  tBTA_AVK_HNDL handle;                   /* handle to use */
 ...
 *
 * Description      This callout function is executed by AVK to set the
 ...
 *                  BTA-AVK maintains the MTU of A2DP streams.
 ...
 *
 ******************************************************************************/
void bta_avk_co_audio_start(tBTA_AVK_HNDL hndl, uint8_t* p_codec_info,
                           bool* p_no_rtp_hdr);
 ...
 *
 ******************************************************************************/
void bta_avk_co_audio_stop(tBTA_AVK_HNDL hndl);
...
/*******************************************************************************
 *
 * Function         bta_avk_co_audio_update_mtu
 *
 * Description      This function is called by AVK when the audio stream
 ...
 **
 ******************************************************************************/
uint8_t bta_avk_co_cp_get_flag(void);
 ...
 **
 ******************************************************************************/
bool bta_avk_co_cp_is_active(void);
