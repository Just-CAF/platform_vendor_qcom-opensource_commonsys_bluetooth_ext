...
static const uint8_t bta_avk_sst_init[][BTA_AVK_NUM_COLS] = {
    ...
    /* CI_SETCONFIG_FAIL_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                                 BTA_AVK_INIT_SST},
    ...
    /* STR_CONFIG_IND_EVT */ {BTA_AVK_SETCONFIG_REJ, BTA_AVK_SIGNORE,
                              BTA_AVK_INIT_SST},
    /* STR_SECURITY_IND_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                                BTA_AVK_INIT_SST},
    /* STR_SECURITY_CFM_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                                BTA_AVK_INIT_SST},
    ...
    /* STR_RECONFIG_CFM_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                                BTA_AVK_INIT_SST},
    ...
    /* API_OFFLOAD_START_EVT */ {BTA_AVK_OFFLOAD_REQ, BTA_AVK_SIGNORE,
                                 BTA_AVK_INIT_SST},
    /* API_OFFLOAD_START_RSP_EVT */ {BTA_AVK_OFFLOAD_RSP, BTA_AVK_SIGNORE,
                                     BTA_AVK_INIT_SST}};

/* state table for incoming state */
static const uint8_t bta_avk_sst_incoming[][BTA_AVK_NUM_COLS] = {
    /* Event                     Action 1               Action 2 Next state */
    /* AP_OPEN_EVT */ {BTA_AVK_OPEN_AT_INC, BTA_AVK_SIGNORE, BTA_AVK_INCOMING_SST},
    /* AP_CLOSE_EVT */ {BTA_AVK_CCO_CLOSE, BTA_AVK_DISCONNECT_REQ,
                        BTA_AVK_CLOSING_SST},
    ...
    /* API_RECONFIG_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                            BTA_AVK_INCOMING_SST},
    /* API_PROTECT_REQ_EVT */ {BTA_AVK_SECURITY_REQ, BTA_AVK_SIGNORE,
                               BTA_AVK_INCOMING_SST},
    /* API_PROTECT_RSP_EVT */ {BTA_AVK_SECURITY_RSP, BTA_AVK_SIGNORE,
                               BTA_AVK_INCOMING_SST},
    /* API_RC_OPEN_EVT  */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                            BTA_AVK_INCOMING_SST},
    /* SRC_DATA_READY_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                              BTA_AVK_INCOMING_SST},
    /* CI_SETCONFIG_OK_EVT */ {BTA_AVK_SETCONFIG_RSP, BTA_AVK_ST_RC_TIMER,
                               BTA_AVK_INCOMING_SST},
    /* CI_SETCONFIG_FAIL_EVT */ {BTA_AVK_SETCONFIG_REJ, BTA_AVK_CLEANUP,
                                 BTA_AVK_INIT_SST},
    /* SDP_DISC_OK_EVT */ {BTA_AVK_FREE_SDB, BTA_AVK_SIGNORE,
                           BTA_AVK_INCOMING_SST},
    /* SDP_DISC_FAIL_EVT */ {BTA_AVK_FREE_SDB, BTA_AVK_SIGNORE,
                             BTA_AVK_INCOMING_SST},
    /* STR_DISC_OK_EVT */ {BTA_AVK_DISC_RES_AS_ACP, BTA_AVK_SIGNORE,
                           BTA_AVK_INCOMING_SST},
    /* STR_DISC_FAIL_EVT */ {BTA_AVK_DISC_FAIL_AS_ACP, BTA_AVK_SIGNORE,
                             BTA_AVK_INCOMING_SST},
    /* STR_GETCAP_OK_EVT */ {BTA_AVK_SAVE_CAPS, BTA_AVK_SIGNORE,
                             BTA_AVK_INCOMING_SST},
    /* STR_GETCAP_FAIL_EVT */ {BTA_AVK_OPEN_FAILED, BTA_AVK_SIGNORE,
                               BTA_AVK_CLOSING_SST},
    /* STR_OPEN_OK_EVT */ {BTA_AVK_STR_OPENED, BTA_AVK_SIGNORE, BTA_AVK_OPEN_SST},
    /* STR_OPEN_FAIL_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                             BTA_AVK_INCOMING_SST},
    /* STR_START_OK_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                            BTA_AVK_INCOMING_SST},
    /* STR_START_FAIL_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                              BTA_AVK_INCOMING_SST},
    /* STR_CLOSE_EVT */ {BTA_AVK_CCO_CLOSE, BTA_AVK_CLEANUP, BTA_AVK_INIT_SST},
    /* STR_CONFIG_IND_EVT */ {BTA_AVK_CONFIG_IND, BTA_AVK_SIGNORE,
                              BTA_AVK_INCOMING_SST},
    /* STR_SECURITY_IND_EVT */ {BTA_AVK_SECURITY_IND, BTA_AVK_SIGNORE,
                                BTA_AVK_INCOMING_SST},
    /* STR_SECURITY_CFM_EVT */ {BTA_AVK_SECURITY_CFM, BTA_AVK_SIGNORE,
                                BTA_AVK_INCOMING_SST},
    /* STR_WRITE_CFM_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                             BTA_AVK_INCOMING_SST},
    /* STR_SUSPEND_CFM_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                               BTA_AVK_INCOMING_SST},
    /* STR_RECONFIG_CFM_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                                BTA_AVK_INCOMING_SST},
    /* AVRC_TIMER_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE, BTA_AVK_INCOMING_SST},
    /* AVDT_CONNECT_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                            BTA_AVK_INCOMING_SST},
    /* AVDT_DISCONNECT_EVT */ {BTA_AVK_CCO_CLOSE, BTA_AVK_CLEANUP,
                            BTA_AVK_INIT_SST},
    /* ROLE_CHANGE_EVT*/ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE, BTA_AVK_INCOMING_SST},
    /* AVDT_DELAY_RPT_EVT */ {BTA_AVK_DELAY_RPT, BTA_AVK_SIGNORE,
                              BTA_AVK_INCOMING_SST},
    /* ACP_CONNECT_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE, BTA_AVK_INCOMING_SST},
    /* API_OFFLOAD_START_EVT */ {BTA_AVK_OFFLOAD_REQ, BTA_AVK_SIGNORE,
                                 BTA_AVK_INCOMING_SST},
...
static const uint8_t bta_avk_sst_opening[][BTA_AVK_NUM_COLS] = {
    /* Event                     Action 1               Action 2 Next state */
    /* AP_OPEN_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE, BTA_AVK_OPENING_SST},
    /* AP_CLOSE_EVT */ {BTA_AVK_DO_CLOSE, BTA_AVK_STR_CLOSED, BTA_AVK_INIT_SST},
    ...
    /* SRC_DATA_READY_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                              BTA_AVK_OPENING_SST},
    /* CI_SETCONFIG_OK_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                               BTA_AVK_OPENING_SST},
    /* CI_SETCONFIG_FAIL_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                                 BTA_AVK_OPENING_SST},
    /* SDP_DISC_OK_EVT */ {BTA_AVK_CONNECT_REQ, BTA_AVK_SIGNORE,
                           BTA_AVK_OPENING_SST},
    /* SDP_DISC_FAIL_EVT */ {BTA_AVK_SDP_FAILED, BTA_AVK_SIGNORE,
                             BTA_AVK_INIT_SST},
    /* STR_DISC_OK_EVT */ {BTA_AVK_DISC_RESULTS, BTA_AVK_SIGNORE,
                           BTA_AVK_OPENING_SST},
    /* STR_DISC_FAIL_EVT */ {BTA_AVK_OPEN_FAILED, BTA_AVK_SIGNORE,
                             BTA_AVK_CLOSING_SST},
    /* STR_GETCAP_OK_EVT */ {BTA_AVK_GETCAP_RESULTS, BTA_AVK_SIGNORE,
                             BTA_AVK_OPENING_SST},
    /* STR_GETCAP_FAIL_EVT */ {BTA_AVK_OPEN_FAILED, BTA_AVK_SIGNORE,
                               BTA_AVK_CLOSING_SST},
    /* STR_OPEN_OK_EVT */ {BTA_AVK_ST_RC_TIMER, BTA_AVK_STR_OPENED,
                           BTA_AVK_OPEN_SST},
    /* STR_OPEN_FAIL_EVT */ {BTA_AVK_OPEN_FAILED, BTA_AVK_SIGNORE,
                             BTA_AVK_CLOSING_SST},
    ...
    /* STR_RECONFIG_CFM_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                                BTA_AVK_OPENING_SST},
    /* AVRC_TIMER_EVT */ {BTA_AVK_SWITCH_ROLE, BTA_AVK_SIGNORE,
                          BTA_AVK_OPENING_SST},
    /* AVDT_CONNECT_EVT */ {BTA_AVK_DISCOVER_REQ, BTA_AVK_SIGNORE,
                            BTA_AVK_OPENING_SST},
    /* AVDT_DISCONNECT_EVT */ {BTA_AVK_CONN_FAILED, BTA_AVK_SIGNORE,
                               BTA_AVK_INIT_SST},
...
static const uint8_t bta_avk_sst_open[][BTA_AVK_NUM_COLS] = {
    /* Event                     Action 1               Action 2 Next state */
    ...
    /* SRC_DATA_READY_EVT */ {BTA_AVK_DATA_PATH, BTA_AVK_SIGNORE,
                              BTA_AVK_OPEN_SST},
    ...
    /* STR_DISC_OK_EVT */ {BTA_AVK_DISC_RES_AS_ACP, BTA_AVK_SIGNORE, BTA_AVK_OPEN_SST},
    /* STR_DISC_FAIL_EVT */ {BTA_AVK_DISC_FAIL_AS_ACP, BTA_AVK_SIGNORE, BTA_AVK_OPEN_SST},
    ...
    /* STR_START_FAIL_EVT */ {BTA_AVK_START_FAILED, BTA_AVK_SIGNORE,
                              BTA_AVK_OPEN_SST},
    ...
    /* STR_SECURITY_CFM_EVT */ {BTA_AVK_SECURITY_CFM, BTA_AVK_SIGNORE,
                                BTA_AVK_OPEN_SST},
    /* STR_WRITE_CFM_EVT */ {BTA_AVK_CLR_CONG, BTA_AVK_DATA_PATH,
                             BTA_AVK_OPEN_SST},
    /* STR_SUSPEND_CFM_EVT */ {BTA_AVK_SUSPEND_CFM, BTA_AVK_SIGNORE,
                               BTA_AVK_OPEN_SST},
    /* STR_RECONFIG_CFM_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                                BTA_AVK_OPEN_SST},
    /* AVRC_TIMER_EVT */ {BTA_AVK_OPEN_RC, BTA_AVK_CHK_2ND_START,
                          BTA_AVK_OPEN_SST},
    /* AVDT_CONNECT_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE, BTA_AVK_OPEN_SST},
    /* AVDT_DISCONNECT_EVT */ {BTA_AVK_STR_CLOSED, BTA_AVK_SIGNORE,
                               BTA_AVK_INIT_SST},
    /* ROLE_CHANGE_EVT*/ {BTA_AVK_ROLE_RES, BTA_AVK_SIGNORE, BTA_AVK_OPEN_SST},
    /* AVDT_DELAY_RPT_EVT */ {BTA_AVK_DELAY_RPT, BTA_AVK_SIGNORE, BTA_AVK_OPEN_SST},
...
static const uint8_t bta_avk_sst_rcfg[][BTA_AVK_NUM_COLS] = {
    /* Event                     Action 1               Action 2 Next state */
    /* AP_OPEN_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE, BTA_AVK_RCFG_SST},
    /* AP_CLOSE_EVT */ {BTA_AVK_DISCONNECT_REQ, BTA_AVK_SIGNORE,
                        BTA_AVK_CLOSING_SST},
    ...
    /* STR_DISC_OK_EVT */ {BTA_AVK_DISC_RESULTS, BTA_AVK_SIGNORE,
                           BTA_AVK_RCFG_SST},
    /* STR_DISC_FAIL_EVT */ {BTA_AVK_STR_CLOSED, BTA_AVK_SIGNORE,
                             BTA_AVK_INIT_SST},
    /* STR_GETCAP_OK_EVT */ {BTA_AVK_GETCAP_RESULTS, BTA_AVK_SIGNORE,
                             BTA_AVK_RCFG_SST},
    /* STR_GETCAP_FAIL_EVT */ {BTA_AVK_STR_CLOSED, BTA_AVK_SIGNORE,
                               BTA_AVK_INIT_SST},
    /* STR_OPEN_OK_EVT */ {BTA_AVK_RCFG_STR_OK, BTA_AVK_SIGNORE, BTA_AVK_OPEN_SST},
    /* STR_OPEN_FAIL_EVT */ {BTA_AVK_RCFG_FAILED, BTA_AVK_SIGNORE,
                             BTA_AVK_RCFG_SST},
    /* STR_START_OK_EVT */ {BTA_AVK_START_OK, BTA_AVK_SIGNORE, BTA_AVK_RCFG_SST},
    ...
    /* STR_SUSPEND_CFM_EVT */ {BTA_AVK_SUSPEND_CFM, BTA_AVK_SUSPEND_CONT,
                               BTA_AVK_RCFG_SST},
    /* STR_RECONFIG_CFM_EVT */ {BTA_AVK_RCFG_CFM, BTA_AVK_SIGNORE,
                                BTA_AVK_RCFG_SST},
    ...
    /* AVDT_DISCONNECT_EVT */ {BTA_AVK_RCFG_DISCNTD, BTA_AVK_SIGNORE,
                               BTA_AVK_RCFG_SST},
    /* ROLE_CHANGE_EVT*/ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE, BTA_AVK_RCFG_SST},
    /* AVDT_DELAY_RPT_EVT */ {BTA_AVK_DELAY_RPT, BTA_AVK_SIGNORE, BTA_AVK_RCFG_SST},
...
static const uint8_t bta_avk_sst_closing[][BTA_AVK_NUM_COLS] = {
    /* Event                     Action 1               Action 2 Next state */
    /* AP_OPEN_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE, BTA_AVK_CLOSING_SST},
    /* AP_CLOSE_EVT */ {BTA_AVK_DISCONNECT_REQ, BTA_AVK_STR_CLOSED,
                        BTA_AVK_INIT_SST},
    ...
    /* API_PROTECT_REQ_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                               BTA_AVK_CLOSING_SST},
    /* API_PROTECT_RSP_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                               BTA_AVK_CLOSING_SST},
    ...
    /* STR_DISC_FAIL_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                             BTA_AVK_CLOSING_SST},
    /* STR_GETCAP_OK_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                             BTA_AVK_CLOSING_SST},
    /* STR_GETCAP_FAIL_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                               BTA_AVK_CLOSING_SST},
    /* STR_OPEN_OK_EVT */ {BTA_AVK_DO_CLOSE, BTA_AVK_SIGNORE, BTA_AVK_CLOSING_SST},
    /* STR_OPEN_FAIL_EVT */ {BTA_AVK_DISCONNECT_REQ, BTA_AVK_SIGNORE,
                             BTA_AVK_CLOSING_SST},
    /* STR_START_OK_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE, BTA_AVK_CLOSING_SST},
    /* STR_START_FAIL_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                              BTA_AVK_CLOSING_SST},
    /* STR_CLOSE_EVT */ {BTA_AVK_DISCONNECT_REQ, BTA_AVK_SIGNORE,
                         BTA_AVK_CLOSING_SST},
    /* STR_CONFIG_IND_EVT */ {BTA_AVK_SETCONFIG_REJ, BTA_AVK_SIGNORE,
                              BTA_AVK_CLOSING_SST},
    /* STR_SECURITY_IND_EVT */ {BTA_AVK_SECURITY_REJ, BTA_AVK_SIGNORE,
                                BTA_AVK_CLOSING_SST},
    /* STR_SECURITY_CFM_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                                BTA_AVK_CLOSING_SST},
    /* STR_WRITE_CFM_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
    ...
    /* AVDT_DELAY_RPT_EVT */ {BTA_AVK_SIGNORE, BTA_AVK_SIGNORE,
                              BTA_AVK_CLOSING_SST},
...
typedef const uint8_t (*tBTA_AVK_SST_TBL)[BTA_AVK_NUM_COLS];

/* state table */
static const tBTA_AVK_SST_TBL bta_avk_sst_tbl[] = {
    bta_avk_sst_init, bta_avk_sst_incoming, bta_avk_sst_opening,
    bta_avk_sst_open, bta_avk_sst_rcfg,     bta_avk_sst_closing};

static const char* bta_avk_sst_code(uint8_t state);
 ...
 *
 ******************************************************************************/
bool bta_avk_is_rcfg_sst(tBTA_AVK_SCB* p_scb) {
  bool is_rcfg_sst = false;

  if (p_scb != NULL) {
    if (p_scb->state == BTA_AVK_RCFG_SST) is_rcfg_sst = true;
  }
 ...
 *
 * Description      Stream state machine event handling function for AVK
 *
 *
 * Returns          void
 *
 ******************************************************************************/
void bta_avk_ssm_execute(tBTA_AVK_SCB* p_scb, uint16_t event,
  ...
  if ((p_scb->state == BTA_AVK_INIT_SST) &&
      (event == BTA_AVK_STR_CONFIG_IND_EVT)) {
  ...
  if ((event != BTA_AVK_STR_WRITE_CFM_EVT) && (event != BTA_AVK_SRC_DATA_READY_EVT))
      APPL_TRACE_IMP("%s(): AVK Sevent(0x%x)=0x%x(%s) state=%d(%s)", __func__,
                     p_scb->hndl, event, bta_avk_evt_code(event), p_scb->state,
                     bta_avk_sst_code(p_scb->state));
      ...
      if (bta_avk_cb.p_scb[xx]) {
        if ((bta_avk_cb.p_scb[xx]->state == BTA_AVK_OPENING_SST) &&
          ...
          break;
                    ...
                    (bta_avk_cb.p_scb[xx] == p_scb) &&
                    (state_table[event][BTA_AVK_SNEXT_STATE] !=
                     BTA_AVK_OPENING_SST)) {
          keep_busy = false;
        }
      }
 ...
 *
 ******************************************************************************/
bool bta_avk_is_scb_opening(tBTA_AVK_SCB* p_scb) {
  bool is_opening = false;

  if (p_scb) {
    if (p_scb->state == BTA_AVK_OPENING_SST) is_opening = true;
  }
 ...
 *
 ******************************************************************************/
bool bta_avk_is_scb_incoming(tBTA_AVK_SCB* p_scb) {
  ...
  if (p_scb) {
    ...
    if (p_scb->state == BTA_AVK_INCOMING_SST) is_incoming = true;
  }
 ...
 *
 ******************************************************************************/
bool bta_avk_is_scb_init(tBTA_AVK_SCB* p_scb) {
  bool is_init = false;

  if (p_scb) {
    if (p_scb->state == BTA_AVK_INIT_SST) is_init = true;
  }
...
static const char* bta_avk_sst_code(uint8_t state) {
  switch (state) {
    case BTA_AVK_INIT_SST:
      return "INIT";
    case BTA_AVK_INCOMING_SST:
      return "INCOMING";
    case BTA_AVK_OPENING_SST:
      return "OPENING";
    case BTA_AVK_OPEN_SST:
      return "OPEN";
    case BTA_AVK_RCFG_SST:
      return "RCFG";
    case BTA_AVK_CLOSING_SST:
      return "CLOSING";
    default:
      return "unknown";
  }
